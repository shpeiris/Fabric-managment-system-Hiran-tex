            ...
            <div className="summary-container">
              ...
              <div className="summary-rows">
                <div className="summary-items-breakdown">
                  {cartItems.map((item) => (
                    <div key={`summary-${item.cart_id}`} className="summary-item-detail">
                      <div className="summary-item-info">
                        <span className="summary-item-name">{item.fabric_name}</span>
                        <span className="summary-item-qty">× {item.quantity}m</span>
                      </div>
                      <span className="summary-item-price">
                        Rs. {(parseFloat(item.quantity) * parseFloat(item.price_per_meter)).toLocaleString(undefined, {minimumFractionDigits: 2})}
                      </span>
                    </div>
                  ))}
                </div>
